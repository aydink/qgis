...
if __name__ == '__main__':
    ...
    print(MGRStoLL("36TTK4390032069"))

#------------------------------------------------------------------------------ 

from qgis.core import *

theVec = processing.getObject(Kaynak_Tablo)
features = theVec.getFeatures()

mgrs_field_index = theVec.fieldNameIndex(MGRS_Alani)

fields = theVec.fields()
for field in fields:
...
for feature in features:
    ...
    try:
        mgrs = MGRStoLL(str(attrs[mgrs_field_index]))
